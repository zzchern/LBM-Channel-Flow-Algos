...
!==========================================================================================
     ...
     fnm = trim(dirbench)//'streaming/cshift'//trim(adjustl(filenum))//'.dat' !Dir not checked in para, must manually create it

     open(60, file = trim(fnm), status = 'unknown',                 &
                 form = 'formatted')

     do i = 1, nsteps
        write(60,600) stream_cshift_bnch(:,i)
     enddo
     close(60)

     fnm = trim(dirbench)//'streaming/exchng'//trim(adjustl(filenum))//'.dat'

     open(59, file = trim(fnm), status = 'unknown',                 &
                 form = 'formatted')

     do i = 1, nsteps
        write(59,599) stream_MPI_bnch(:,i)
     enddo
     close(59)

600   format(2x,30(1f16.10))
599   format(2x,20(1f16.10))
     end subroutine bench_streaming
!==========================================================================================
!==========================================================================================