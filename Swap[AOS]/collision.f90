!===========================================================================
      ...
      do iy = 1,ly
       if(iy==1)then
          f(4,1,iy,iz) = f(3,1,iy-1,iz)
          f(4,lx,iy,iz) = f(3,lx,iy-1,iz)
          f(10,lx,iy,iz) = f(7,lx-1,iy-1,iz)
          f(9,1,iy,iz) = f(8,2,iy-1,iz)
          f(18,1,iy,iz) = f(15,1,iy-1,iz-1)
          f(18,lx,iy,iz) = f(15,lx,iy-1,iz-1)
        endif

        if(iz==1)then
          f(6,1,iy,iz) = f(5,1,iy,iz-1)
          f(6,lx,iy,iz) = f(5,lx,iy,iz-1)
          f(13,1,iy,iz) = f(12,2,iy,iz-1)
          f(14,lx,iy,iz) = f(11,lx-1,iy,iz-1)
          f(17,1,iy,iz) = f(16,1,iy+1,iz-1)
          f(17,lx,iy,iz) = f(16,lx,iy+1,iz-1)
          if(iy .ne. 1)then
            f(18,1,iy,iz) = f(15,1,iy-1,iz-1)
            f(18,lx,iy,iz) = f(15,lx,iy-1,iz-1)
          endif
        ...
        !if(myid==0 .AND. iz == 1 .AND. iy ==1)write(*,*)"==",f(12,2,iy,iz-1),f(2,2,iy,iz),f(10,2,iy+1,iz),"=="
        tempDist = f(1,1,iy,iz)
        f(1,1,iy,iz) = f(2,2,iy,iz)
        f(2,2,iy,iz) = tempDist

        tempDist = f(3,1,iy,iz)
        f(3,1,iy,iz) = f(4,1,iy+1,iz)
        f(4,1,iy+1,iz) = tempDist

        tempDist = f(3,lx,iy,iz)
        f(3,lx,iy,iz) = f(4,lx,iy+1,iz)
        f(4,lx,iy+1,iz) = tempDist

        tempDist = f(5,1,iy,iz)
        f(5,1,iy,iz) = f(6,1,iy,iz+1)
        f(6,1,iy,iz+1) = tempDist

        tempDist = f(5,lx,iy,iz)
        f(5,lx,iy,iz) = f(6,lx,iy,iz+1)
        f(6,lx,iy,iz+1) = tempDist

        tempDist = f(7,1,iy,iz)
        f(7,1,iy,iz) = f(10,2,iy+1,iz)
        f(10,2,iy+1,iz) = tempDist

        tempDist = f(8,lx,iy,iz)
        f(8,lx,iy,iz) = f(9,lx-1,iy+1,iz)
        f(9,lx-1,iy+1,iz) = tempDist

        tempDist = f(11,1,iy,iz)
        f(11,1,iy,iz) = f(14,2,iy,iz+1)
        f(14,2,iy,iz+1) = tempDist

        tempDist = f(12,lx,iy,iz)
        f(12,lx,iy,iz) = f(13,lx-1,iy,iz+1)
        f(13,lx-1,iy,iz+1) = tempDist

        tempDist = f(15,1,iy,iz)
        f(15,1,iy,iz) = f(18,1,iy+1,iz+1)
        f(18,1,iy+1,iz+1) = tempDist

        tempDist = f(15,lx,iy,iz)
        f(15,lx,iy,iz) = f(18,lx,iy+1,iz+1)
        f(18,lx,iy+1,iz+1) = tempDist

        tempDist = f(16,1,iy,iz)
        f(16,1,iy,iz) = f(17,1,iy-1,iz+1)
        f(17,1,iy-1,iz+1) = tempDist

        tempDist = f(16,lx,iy,iz)
        f(16,lx,iy,iz) = f(17,lx,iy-1,iz+1)
        f(17,lx,iy-1,iz+1) = tempDist
      enddo
      enddo
      ...
      do ix = 2,lx-1
        if(iy==1)then
          f(4,ix,iy,iz) = f(3,ix,iy-1,iz)
          f(10,ix,iy,iz) = f(7,ix-1,iy-1,iz)
          f(9,ix,iy,iz) = f(8,ix+1,iy-1,iz)
          f(18,ix,iy,iz) = f(15,ix,iy-1,iz-1)
        endif

        if(iz==1)then
          f(6,ix,iy,iz) = f(5,ix,iy,iz-1)
          f(13,ix,iy,iz) = f(12,ix+1,iy,iz-1)
          f(14,ix,iy,iz) = f(11,ix-1,iy,iz-1)
          f(17,ix,iy,iz) = f(16,ix,iy+1,iz-1)
          if(iy .ne. 1) f(18,ix,iy,iz) = f(15,ix,iy-1,iz-1)
        endif
        ...
        tempDist = f(1,ix,iy,iz)
        f(1,ix,iy,iz) = f(2,ix+1,iy,iz)
        f(2,ix+1,iy,iz) = tempDist

        tempDist = f(3,ix,iy,iz)
        f(3,ix,iy,iz) = f(4,ix,iy+1,iz)
        f(4,ix,iy+1,iz) = tempDist

        tempDist = f(5,ix,iy,iz)
        f(5,ix,iy,iz) = f(6,ix,iy,iz+1)
        f(6,ix,iy,iz+1) = tempDist

        tempDist = f(7,ix,iy,iz)
        f(7,ix,iy,iz) = f(10,ix+1,iy+1,iz)
        f(10,ix+1,iy+1,iz) = tempDist

        tempDist = f(8,ix,iy,iz)
        f(8,ix,iy,iz) = f(9,ix-1,iy+1,iz)
        f(9,ix-1,iy+1,iz) = tempDist

        tempDist = f(11,ix,iy,iz)
        f(11,ix,iy,iz) = f(14,ix+1,iy,iz+1)
        f(14,ix+1,iy,iz+1) = tempDist

        tempDist = f(12,ix,iy,iz)
        f(12,ix,iy,iz) = f(13,ix-1,iy,iz+1)
        f(13,ix-1,iy,iz+1) = tempDist

        tempDist = f(15,ix,iy,iz)
        f(15,ix,iy,iz) = f(18,ix,iy+1,iz+1)
        f(18,ix,iy+1,iz+1) = tempDist
        
        tempDist = f(16,ix,iy,iz)
        f(16,ix,iy,iz) = f(17,ix,iy-1,iz+1)
        f(17,ix,iy-1,iz+1) = tempDist

        do ip =0, npop-1
          f9(ipopp(ip)) = f(ip,ix,iy,iz)
        enddo
      ...
      do iy = 1,ly
        do ip =0, npop-1
          f9(ipopp(ip)) = f(ip,lx,iy,iz)
        enddo
        ix = lx
        call collision_MRT(f9,ix,iy,iz,f(:,ix,iy,iz))

        do ip =0, npop-1
          f9(ipopp(ip)) = f(ip,1,iy,iz)
        enddo
        ix = 1
        call collision_MRT(f9,ix,iy,iz,f(:,ix,iy,iz))
      enddo
